...
| Mendelian randomisation | Reusable functions, compact manuscript-aligned microbiome, prioritised-thyroxine and pQTL intermediates/results, public-data manifest | Multi-gigabyte GWAS files, LD-reference binaries, immune-cell-trait analyses, non-prioritised-metabolite analyses, mediation analyses not reported in the manuscript, backups, colocalisation workflow |
